...
public class EncryptProcessor extends AbstractProcessor {
    ...
    public synchronized void init(ProcessingEnvironment environment) {
        ...
        mCodeGenerator = new CodeGenerator(mElements, filer);
    ...
    public Set<String> getSupportedAnnotationTypes() {
        ...
        annotations.add(StringEncryption.class.getCanonicalName());
        return annotations;
    }

    @Override
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment environment) {
        Set<? extends Element> elements = environment.getElementsAnnotatedWith(StringEncryption.class);
